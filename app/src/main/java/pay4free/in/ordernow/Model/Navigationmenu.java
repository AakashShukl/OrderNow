...
import pay4free.in.ordernow.Cart;
import pay4free.in.ordernow.CategoryList;
import pay4free.in.ordernow.Interface.ItemClickListener;
import pay4free.in.ordernow.R;
import pay4free.in.ordernow.ViewHolder.CentreViewHolder;
...
public class Navigationmenu extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       centrelist=database.getReference("Centre");
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
             //   Snackbar.make(view, "Replace with your own action", Snackbar.LENGTH_LONG)
                ...
                startActivity(new Intent(Navigationmenu.this,Cart.class));
            }
        });
*/
      ...
      //name.setText(Common.currentuser.getDisplayName());
            ...
            protected void populateViewHolder(CentreViewHolder viewHolder, CenterShow model, int position) {
              ...
              viewHolder.setItemClickListener(new ItemClickListener() {
                    ...
                    public void onClick(View view, int position, boolean isLongClick) {
                       ...
                       Intent catList=new Intent(Navigationmenu.this, CategoryList.class);
                        catList.putExtra("CategoryId",adapter.getRef(position).getKey());
...
startActivity(new Intent(Navigationmenu.this,OrderStatus.class));
        } else if (id == R.id.nav_logout) {
           Intent signIn=new Intent(Navigationmenu.this,MainActivity.class);
